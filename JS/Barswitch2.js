...
d3.csv('https://raw.githubusercontent.com/Jaga-droid/Covid_Data_StoryBoard/main/Resources/DataSet/Geography/' +
    ...
    u2
        ...
        .attr("height", d => barswitch_height_2 - ybar1(d.value))
        .attr("fill", "#69b3a2")
});
}
